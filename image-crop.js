            ...
            return {
                ...
                link: function (scope, element, attributes) {
                    ...
                    function handleSize(base64ImageSrc) {
                        //console.log("执行handleSize函数");
                        var defer = $q.defer();

                        if(!maxSize) {
                            defer.resolve(base64ImageSrc);
                        }
                        ...
                        img.onload = function() {
                            ...
                            //
                            if(height<441 || width<358){
                                alert("照片大小不符合，照片尺寸至少为358 x 441,请重新上传");
                                return;
                            };
                            ...
                            context.save();
                            //console.log("context.save()之后打印context")
                            //console.log(context);
                            //console.log(canvas);
                    ...
                    $finalImg.onload = function() {
                        //console.log("开始执行$finalImg函数");
                        //console.log($finalImg);
                        //console.log($finalImg.width);
                        //console.log($finalImg.height);
                        var tempCanvas = document.createElement('canvas');
                        //tempCanvas.width = this.width - padding;
                        tempCanvas.width = 358;
                        //tempCanvas.height = this.height - padding;
                        tempCanvas.height = 441;
                        ...
                        //console.log("doCrop后执行$finalImg.onload函数");
